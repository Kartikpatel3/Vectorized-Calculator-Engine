        ...
        if user_input == "1":
            ...
            if user_input == "1":
                ...
                try:
                    ...
                    print("\nPlease!!! Enter Input as a List With Proper Commas and Brackets.")
                    continue
                performance.Mul(first, second, user_dim)
            elif user_input == "4":
                user_dim = input("Enter Your Dimentions of Array = ")
                try:
                    first = ast.literal_eval(input("\nNOW >> \nEnter First Array = "))
            ...
            user_input = input("ENTER YOUR KEY >> ")
            if user_input == "1":
                user_dim = input("Enter Your Dimentions of Matrix = ")
                try:
                    first = ast.literal_eval(input("\nNOW >> \nEnter First Matrix = "))
                    ...
                    print("\nPlease!!! Enter Input as a List With Proper Commas and Brackets.")
                    continue
                performance.MatMul(first, second, user_dim)
            elif user_input == "2":
                user_dim = input("Enter Your Dimentions of Matrix = ")
                try:
                ...
                user_dim = input("Enter Your Dimentions of Vectors = ")
                try:
                    first = ast.literal_eval(input("\nNOW >> \nEnter First Vector = "))
                ...
                ord_type = input("Enter ord for Norm Value = ")
                try:
                    first = ast.literal_eval(input("\nNOW >> \nEnter Vector = "))
                except:
                    print("\nPlease!!! Enter Input as a List With Proper Commas and Brackets.")
